...
export const OPCIONES_TIPO_SEGURO = [
...
export const OPCIONES_ESTADO_POLIZA = [
...
export const camposPoliza: FieldMeta[] = [
  {
    ...
    options: [] // 🔄 Se carga dinámicamente en polizas.ts
  },
  {
    name: 'numero',
  ...
  },
  {
    ...
    type: 'select',
    options: OPCIONES_TIPO_SEGURO,
    validators: [Validators.required]
  },
  {
    name: 'empresaAseguradoraId',
    label: 'Aseguradora',
    type: 'text',
    validators: [Validators.required]
  },
  ...
  },
  {
    name: 'adjuntos',
    label: 'Adjuntos',
    type: 'text' // Por ahora simple, puede cambiarse a file[]
  },
  {
    name: 'estado',
    label: 'Estado',
    type: 'select',
    options: OPCIONES_ESTADO_POLIZA,
    validators: [Validators.required]
  }
];
...
export function normalizarFecha(fecha: any): Date {
  return (fecha?.toDate instanceof Function) ? fecha.toDate() : new Date(fecha);
}

export function formatearFechaLocal(fecha: any): string {
